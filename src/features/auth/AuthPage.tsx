        ...
        <form className="space-y-4" noValidate onSubmit={(e) => void onSubmit(e)}>
          ...
          <AuthField
            ...
            trailing={
              <button
                type="button"
                className="absolute inset-y-0 right-0 flex min-w-12 items-center justify-center text-ink-muted hover:text-ink"
          ...
          <button
            type="button"
            className="inline-flex w-full items-center justify-center gap-1.5 text-sm font-medium text-ink-muted underline-offset-4 hover:underline"
            onClick={() => {
              clearRole()
