  ...
  return createPortal(
    ...
    >
      <div
        ...
        aria-live="polite"
        className={cn(
          'pointer-events-auto relative flex items-start gap-3 rounded-[var(--radius-labas)] border px-3 py-3 pr-10 text-sm font-medium shadow-[0_12px_40px_-12px_rgba(16,40,96,0.4)]',
