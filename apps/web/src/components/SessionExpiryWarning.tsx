...
export function SessionExpiryWarning() {
  ...
  return (
    ...
    >
      <Dialog.Portal>
        <Dialog.Overlay className="labas-overlay fixed inset-0 z-[60] bg-ink/45" />
        <Dialog.Content className="labas-dialog-panel fixed left-1/2 top-1/2 z-[61] w-[min(100%-2rem,22rem)] -translate-x-1/2 -translate-y-1/2 rounded-[var(--radius-labas)] border border-border bg-surface p-5 shadow-lg outline-none">
