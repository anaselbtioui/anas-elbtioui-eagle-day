...
export function AvatarSettingsButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        'flex h-10 w-10 items-center justify-center rounded-full text-ink-muted transition-[transform,background-color,color] duration-150 ease-out hover:bg-sand-deep hover:text-ink active:scale-[0.96]',
        className,
      )}
