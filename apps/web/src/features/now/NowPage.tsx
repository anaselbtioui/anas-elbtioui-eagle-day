      ...
      {step === 'constat' ? (
        <WizardSection title={t('now.constatTitle')} hint={t('now.constatHint')}>
          ...
          <div className="space-y-3">
            ...
            <label className="flex min-h-12 items-start gap-3 rounded-[var(--radius-labas)] border-2 border-border p-4">
              <input
                type="checkbox"
                ...
                >
                  ...
                  {photo ? (
                    <img
                      src={photo}
                      alt={label}
                      className="mb-3 h-36 w-full rounded-lg object-cover shadow-[inset_0_0_0_1px_oklch(0_0_0/0.1)]"
                    />
                  ) : null}
