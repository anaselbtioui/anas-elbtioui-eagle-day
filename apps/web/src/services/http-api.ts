...
export const httpApi: LabasHttpApi = {
  ...
  uploadPhoto: (incidentId, input) =>
    req(`/api/packs/${incidentId}/photos`, {
      method: 'POST',
      body: JSON.stringify(input),
    }),
  photoSignedUrl: (incidentId, photoId) =>
    req(`/api/packs/${incidentId}/photos/${encodeURIComponent(photoId)}/url`),
